...
def clear_video_state() -> None:
    ...
    keys_to_clear = [
        ...
        "form_eval_report_paths",
        "comparison_video_cache",
        "comparison_video_css_applied",
        "comparison_report_select",
        "comparison_pair_select",
        "squat_eval_mode_select",
        "deadlift_eval_mode_select",
        "evaluation_mode",
        "saved_user_clips",
        "manual_trim_source_file_id",
        "manual_trim_source_path",
        "manual_trim_total_frames",
        "manual_trim_fps",
        "manual_trim_width",
        "manual_trim_height",
        "manual_trim_rotation_deg",
        "manual_trim_ranges",
        "manual_trimmed_videos",
        "manual_detect_signature",
        "manual_detect_log",
        "manual_template_select",
        "manual_template_video_bytes",
        "manual_template_video_name",
        "post_template_trim_mode",
        "results_target_multiselect",
        "results_target_preview_select",
        "results_template_select",
    ]
