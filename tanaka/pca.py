...
def visualize_pca_wave(pc1, explained_variance, title="Squat Movement Analysis"):
    ...
    peaks, _ = find_peaks(-pc1, distance=30, prominence=0.1)
...
if __name__ == "__main__":
    ...
    # PCAで分析してグラフを保存
    pc1, peaks = perform_pca(format_data_for_pca(all_frames_data))
